...
\begin{table*}[htbp]
	...
	\input{figures_tables/table_planar_quotes.tex}
\end{table*}
...
\begin{figure}[htbp]
	\includegraphics[width=0.48\textwidth]{figures_tables/regression_phi_split.png}
